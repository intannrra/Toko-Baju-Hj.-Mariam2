              ...
              <div class="card-body">
                ...
                <form action="{{ route('transactions.store') }}" method="post" novalidate>
                  ...
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="user_id" id="floatingUser" placeholder="Id Customer" value="{{ old('user_id') }}" required>
                    <label for="floatingUser">Id User</label>
                    <div class="invalid-feedback">User wajib diisi.</div>
                  </div>

                  <!-- Input product -->
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="product" id="floatingProduct" placeholder="Produk" value="{{ old('product') }}" required>
                  ...
                  <!-- Input total -->
                  <div class="form-floating mb-3">
                    <input type="number" class="form-control" name="total" id="floatingTotal" placeholder="Total" value="{{ old('total') }}" required>
                  ...
                  <!-- Input price -->
                  <div class="form-floating mb-3">
                    <input type="number" class="form-control" name="price" id="floatingPrice" placeholder="Harga" value="{{ old('price') }}" required>
